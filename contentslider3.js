...
ajaxconnect:function ajaxConnect(setting) {
	$.ajax({
...
ajaxpopulate:function ajaxPopulate(page_request, setting) {
	if (page_request.readyState == 4 && (page_request.status==200 || window.location.href.indexOf("http")==-1)) {
	  $('#' + setting.id).html(page_request.responseText);
	  var paragraph = document.getElementById("About");
